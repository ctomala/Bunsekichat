...
BUNSEKI_FRONTEND_LOGO_DATA_URI = "data:image/png;base64,"
...
def adaptive_practice_questions(uid, current_topic, difficulty, n_questions=5, round_no=1):

    """Práctica local, rápida y sin nota. No modifica el nivel oficial del estudiante."""
    ...
    if len(candidates) < int(n_questions):
        ...
        # Respaldo para materias que todavía no tienen banco validado estructurado.
        ...
        for q_topic, qdata in adaptive_quiz_for_user(uid, current_topic):
            ...
            candidates.append({
                ...
                "explanation": f"Repasa el concepto central relacionado con {q_topic} y justifica por qué la opción correcta responde al problema.",
    ...
    # Evita repeticiones dentro del mismo bloque y cambia la selección en cada ronda.
    ...
    seed_raw = f"practice|{uid}|{current_topic}|{difficulty}|{int(round_no)}"

    rng = random.Random(hashlib.sha256(seed_raw.encode("utf-8")).hexdigest())
...
def login_page():
    ...
    st.markdown(
        "<div class='bunseki-login-brand'>"
        f"<img class='bunseki-login-mark' "
        f"src='{BUNSEKI_FRONTEND_LOGO_DATA_URI}' "
        f"alt='BunsekiChat'>"
        "<div class='bunseki-login-name' aria-label='BunsekiChat'>"
        "<span class='bunseki-login-wordmark-dark'>Bunseki</span>"
        "<span class='bunseki-login-wordmark-accent'>Chat</span>"
        "</div>"
        "<div class='bunseki-login-subtitle'>"
        "Tutor matemático que analiza tu proceso, conversa contigo "
        "y conserva evidencia útil de aprendizaje."
        "</div>"
        "</div>",
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        <div class="bunseki-login-help">

            Acceso académico seguro · Tus avances se conservan en tu cuenta.

        </div>

        <div class="bunseki-login-signature">BunsekiChat · Christian Tomalá</div>
...
def student_page(user):
    ...
    with right:
        ...
        level_state_key = f"adaptive_practice_level_choice_{user['id']}_{strip_accents(practice_topic).lower()}"
        ...
        practice_key = f"adaptive_practice_state_{user['id']}_{strip_accents(practice_topic).lower()}"
        ...
        selection_signature = f"{practice_topic}|{practice_level_choice}"
        ...
        if practice_result:
            ...
            for prompt_text in adaptive_learning_prompts(
                ...
                practice_result.get("weak_topics"),
